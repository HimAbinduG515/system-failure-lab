...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background grid-pattern">
      <Header onRecoverAll={recoverAll} onClearHistory={clearHistory} />
        ...
        <div className="mb-8">
          <div className="max-w-2xl">
            ...
            <p className="text-muted-foreground">
              ...
              intuition for designing resilient backend architectures.
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground pl-8">
                  Use the "Stop Service" or "Add Latency" buttons on any service card to simulate failures.
                </p>
              </div>
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-primary/20 text-primary text-sm font-bold flex items-center justify-center">2</span>
                  <h4 className="font-medium text-foreground">Observe Effects</h4>
                </div>
                <p className="text-sm text-muted-foreground pl-8">
                  Watch how failures cascade through dependent services and track metrics in real-time.
                </p>
              </div>
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                ...
                <p className="text-sm text-muted-foreground pl-8">
                  Review experiment insights, then recover services to observe the healing process.
                </p>
              </div>
            </div>
          </div>
